...
const SEED_PRODUCTS = [
  ...
  { id: '4', name: 'Pods Max Vendor', slug: 'pods-max-vendor', original_price: 19.99, sale_price: 9.99, is_on_sale: true, is_bundle: false, category: 'electronics', active: true },
  { id: '5', name: 'Pods Vendor', slug: 'pods-vendor', original_price: 22.99, sale_price: 9.99, is_on_sale: true, is_bundle: false, category: 'electronics', active: true },
  { id: '6', name: 'Labubu Vendor', slug: 'labubu-vendor', original_price: 22.99, sale_price: 9.99, is_on_sale: true, is_bundle: false, category: 'toys', active: true },
  ...
  { id: '11', name: 'Golf Club Vendor', slug: 'golf-club-vendor', original_price: 19.99, sale_price: 9.99, is_on_sale: true, is_bundle: false, category: 'sports', active: true },
